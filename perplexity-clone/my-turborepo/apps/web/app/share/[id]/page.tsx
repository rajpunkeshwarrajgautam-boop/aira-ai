...
export default async function SharePage({
	...
	return (
		<div className="aira-shell min-h-dvh w-full overflow-hidden">
			<div className="aira-orb aira-orb-blue -left-16 top-32 size-28 opacity-35" aria-hidden />
			<div className="aira-orb aira-orb-violet -right-14 top-20 size-24 opacity-35" aria-hidden />
			<div className="relative z-10 flex min-h-dvh flex-col">
				...
				<main className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-6 px-4 pb-12 pt-3 md:px-6 md:pt-6">
					...
					<section className="aira-premium-card aira-card-hover flex flex-col gap-3 rounded-3xl p-5 sm:p-6">
