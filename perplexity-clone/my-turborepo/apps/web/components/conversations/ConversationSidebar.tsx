...
const APP_RAIL = [
	...
	{ href: "/omniroute", label: "OmniRoute", icon: Network },
	...
	return (
		...
		>
			<nav className="aira-app-rail flex w-[72px] shrink-0 flex-col items-center border-r border-border-subtle px-2 py-3" aria-label="AIRA applications">
				<Link href="/" className="mb-4 grid size-11 place-items-center rounded-xl border border-accent/20 bg-accent/10 text-[13px] font-semibold text-accent" aria-label="AIRA AI home">
					A
				</Link>
						...
						return (
							<Link
								...
								className={cn(
									...
									active ? "bg-accent/15 text-accent" : "hover:bg-white/[0.045] hover:text-content-primary",
								)}
							>
