...
flowchart TD
    ...
    subgraph AIRouting ["Model Routing & Resilience Facade"]
        ...
        NVIDIA["NVIDIA NIM (Nemotron-3-nano)"]
...
- Production Direct Providers: **NVIDIA NIM** (`nvidia/nemotron-3-nano-30b-a3b` default free model) and **OpenAI** (`gpt-4o-mini`).
...
## 9. Agent Execution & Orchestration

### 9.1 Autonomous Runtimes
