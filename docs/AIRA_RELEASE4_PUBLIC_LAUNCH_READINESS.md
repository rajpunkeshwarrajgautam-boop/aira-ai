...
| **AIRA Work** | `WORKING_E2E_IN_PREVIEW` (in progress) | `PRODUCTION_CONFIGURATION_REQUIRED` | Managed runtime provider, distributed rate limiting, server quotas | No (depends on Phase 4/5) | Bind server-authoritative budgets, mission control UI, dedicated runtime probe, deliverable store. | Agent Platform / Work Orchestrator | `1debb0f0618684f7db6eb1a1ef47e85108164509` |
