...
graph TD
    ...
    Route -->|Gateway| OmniRoute[OmniRoute Local/Remote Gateway]
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **AIRA Route** | `/omniroute` | `/api/compare`, `/api/route` | Local/Remote Gateway Config | `PARTIALLY_WORKING` | Resilient fallback to direct providers; gateway discovery. |
