...
### Skill: postgres-wizard / supabase-backend / cybersecurity / privacy-guardian / backend / code-quality
- **Purpose**: Gate 17 — Production PostgreSQL TLS / SSL hardening specification and driver deprecation resolution.
- **Files inspected**: `prisma/schema.prisma`, `lib/prisma.ts`, `node_modules/pg`, `docs/AIRA_RELEASE4_PUBLIC_LAUNCH_READINESS.md`, `docs/AIRA_RELEASE4_PRODUCTION_DEPENDENCIES.md`, `docs/AIRA_RELEASE4_PRODUCTION_RUNBOOK.md`.
- **Files modified**: `docs/AIRA_RELEASE4_PUBLIC_LAUNCH_READINESS.md`, `docs/AIRA_RELEASE4_PRODUCTION_DEPENDENCIES.md`, `docs/AIRA_RELEASE4_PRODUCTION_RUNBOOK.md`, `docs/AIRA_RELEASE4_SKILL_LEDGER.md`.
